...
class EmpleoController extends BaseSiteController
{
    ...
    public function setEmpleoFolder($userId, $empleoId)
    {
        ...
        $folderDestinoHomeThumbnail = $folderAd . '/' . 'home-thumbnail' ;
        ...
        if( file_exists($folderDestinoHomeThumbnail)){
        } else { 
                mkdir($folderDestinoHomeThumbnail, 0777);
                chmod($folderDestinoHomeThumbnail, 0777);
        }
    ...
    public function executeEmpleoUploadHomeGalleryPicsAction()
    {
        ...
        $this->setEmpleoFolder($userId, $empleoId);
        $targetFolderOriginal = $basicPathPic . '/' . $userId . '/' . $empleoId . '/home-thumbnail';
