...
class HotelController extends BaseSiteController
{
    ...
    public function indexAction()
    {
        ...
        /* SET*/
        $title =  $advert["featured"]["titulo_seo"];
        $seo =  $advert["featured"]["contenido_seo"];
        $this->view->headTitle($title);
        $this->view->headMeta()->setName('description', $seo);
    ...
    public function listadoAction() {
        ...
        $hoteles = array();
        $repository = new Application_Model_Repository_Statement();
        $hoteles = $repository->fetchAllHotelesWithOutState();

        
        $this->view->adsUpdated = $hoteles;
        
       //die('HOTELES: <pre>' . print_r($hoteles, true) . '</pre>');
